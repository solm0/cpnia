...
export default function InterviewUi() {
  ...
  return (
    <div className="absolute left-1/2 top-0 h-screen w-1/2 flex flex-col items-center justify-center gap-30">
      <div className="absolute top-20 left-0 w-full text-sm text-gray-700 flex flex-col gap-4 text-center items-center">
